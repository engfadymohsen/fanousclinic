...
const MVV = () => {
    return (
      <Box sx={{
          ...
          flexDirection: 'row', // Flex direction as row
          alignItems: 'stretch', // Align items to stretch to fill the container
      }}>
          <Grid container spacing={2}>
              <Grid item xs={12} sm={6} md={6}>
                  <Box sx={{minHeight: '50vh', display: 'flex', flexDirection: 'column', alignItems: 'center', boxShadow: '0px 0px 6px #0334492f', padding: '20px', borderRadius: '15px'}}>
