  ...
  const services = [
    {
      ...
      content:
        "We offer extended hours of services for our patients to manage their urgent medical needs. We believe that we have to be there for our patients population when they need urgent services outside off regular working hours.",
    },
    {
