  ...
  return (
    <Box sx={{backgroundColor:theme.primary_color, overflow:'hidden', position:'relative'}}>
        ...
        <Box sx={{padding:{md:'4rem 6rem', xs:'1rem 1rem',},width:{md:'60%', xs:'90%'}, color:'white'}}>
            <Typography sx={{fontSize:'4rem', marginBottom:'20px',lineHeight:{xs:'1', md:'auto'}, color:'white'}} ><span style={{fontWeight:'600', color:theme.sec_color}}>OUR </span><span  style={{fontWeight:'200', color:theme.sec_color}}>STORY</span></Typography>
            <Typography sx={{fontSize:theme.body_font, fontWeight:'400', textAlign:'left'}}>
