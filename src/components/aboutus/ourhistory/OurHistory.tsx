...
const OurHistory = () => {
  return (
    <Box sx={{backgroundColor:theme.primary_color, overflow:'hidden', position:'relative'}}>
        ...
        <Box sx={{padding:{lg:'4rem 6rem',md:'4rem 6rem', xs:'2rem 2rem',sm:'2rem 2rem'},width:{md:'60%'}, color:'white',textAlign: { lg: "left", md: "left", sm: "center", xs: "center" }}}>
            <Typography sx={{fontSize:{ lg: "4rem", md: "4rem", sm: "2rem", xs: "2rem" }, marginBottom:'20px',lineHeight:{xs:'1', md:'auto'}, color:'white'}} ><span style={{fontWeight:'600', color:theme.sec_color}}>OUR </span><span  style={{fontWeight:'200', color:theme.sec_color}}>STORY</span></Typography>
            <Typography sx={{fontSize:theme.body_font, fontWeight:'400'}}>
            ...
            <Typography sx={{color:theme.sec_color,fontSize:theme.body_font, fontWeight:'600', marginTop:'2rem'}}>And so, from this profound insight, Fanous Clinic was conceived.  </Typography>
        </Box>
    </Box>
  )
}
