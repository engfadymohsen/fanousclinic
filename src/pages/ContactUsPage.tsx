  ...
  return (
    <Box ref={scrollToTop}>
        ...
        boxSizing:'border-box'
          ...
          <Typography sx={{fontSize:{ lg: "4rem", md: "4rem", sm: "2rem", xs: "2rem" },lineHeight:{xs:'1', md:'auto'}, color:'white', textAlign: { lg: "left", md: "left", sm: "center", xs: "center" }}} ><span style={{fontWeight:'600', color:theme.primary_color}}>CONTACT </span><span style={{fontWeight:'200', color:theme.primary_color}}>US</span></Typography>
